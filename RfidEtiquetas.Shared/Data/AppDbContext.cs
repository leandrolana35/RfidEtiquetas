...
public class AppDbContext
{
    ...
    private void InitializeDatabase()
    {
        ...
        conn.ExecuteNonQuery(@"
            CREATE TABLE IF NOT EXISTS Etiquetas (
                ...
                RfidTamanhoBits INT DEFAULT 96, RfidEncodingTipo INT DEFAULT 0, RfidAlinhamento INT DEFAULT 0, RfidPrefixo VARCHAR(20) DEFAULT '',
        ...
        AddColumnIfMissing(conn, "Etiquetas", "RfidAlinhamento", "INT DEFAULT 0");
        ...
        if (e.Id == 0)
        {
            cmd.CommandText = @"
                INSERT INTO Etiquetas (Modelo,EtiquetaX,EtiquetaY,LarguraMm,AlturaMm,DefinirTamanho,
                    ...
                    RfidAtivo,RfidBanco,RfidTamanhoBits,RfidEncodingTipo,RfidAlinhamento,RfidPrefixo,
                ...
                VALUES ($modelo,$ex,$ey,$lmm,$amm,$dt,
                    ...
                    $ra,$rb,$rtb,$ret,$ralin,$rp,$riv,$rvx,$rvy,$rvt,$li,$la,$lx,$ly,$ll,$lal,
                    $int,$qtd,$vel,$den);
        ...
        else
        {
            cmd.CommandText = @"
                UPDATE Etiquetas SET Modelo=$modelo,EtiquetaX=$ex,EtiquetaY=$ey,LarguraMm=$lmm,AlturaMm=$amm,DefinirTamanho=$dt,
                    ...
                    RfidAtivo=$ra,RfidBanco=$rb,RfidTamanhoBits=$rtb,RfidEncodingTipo=$ret,RfidAlinhamento=$ralin,RfidPrefixo=$rp,
    ...
    private static Etiqueta MapEtiqueta(SqliteDataReader r) => new()
    {
        ...
        RfidAlinhamento = r.GetInt32(r.GetOrdinal("RfidAlinhamento")),
    ...
    private static void BindEtiqueta(SqliteCommand cmd, Etiqueta e)
    {
        ...
        cmd.Parameters.AddWithValue("$rtb", e.RfidTamanhoBits); cmd.Parameters.AddWithValue("$ret", e.RfidEncodingTipo); cmd.Parameters.AddWithValue("$ralin", e.RfidAlinhamento); cmd.Parameters.AddWithValue("$rp", e.RfidPrefixo);
